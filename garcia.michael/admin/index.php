...
$empty_product = (object)[
	"name"=>"House Plant",
	"description"=>"Large house plant that is safe for pets!",
	"price"=>"19.95",
	"category"=>"plants",
	"size"=>"small",
	"thumbnail"=>"1.jpg",
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	<h2>$addoredit Product</h2>
		...
		<div class="form-control">
			...
			<input class="form-input" name="product-quantity" id="product-quantity" type="Number" min="0" max="1000" step="0.01" value="$o->quantity" placeholder="Enter the Product Quantity">
		</div>
		<div class="form-control">
