...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
		...
		<div class="form-control">
			...
			<input class="form-input" name="user-classes" id="user-classes" type="text" value="$classes" placeholder="Enter the User Email, comma separated">
			</div>


			<div class="form-control">
			<input class="form-input" type="submit" value="Save Changes">
			</div>
